...
class RouteServiceProvider extends ServiceProvider
{
    ...
    private function mapWebRoutes()
    {
		...
		Route::get('airman', 'AirmanController@index')->name('airman');            
		Route::get('pilots', 'AirmanController@index')->name('frontend.pilots.index');
		Route::get('flightschool', 'FlightSchoolController@index')->name('flightschool');
		Route::get('flightschool/program', 'FlightSchoolController@program')->name('flightschool.program');
		});
