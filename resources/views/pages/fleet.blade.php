...
<div class="container py-5 text-light">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <div class="col">
            <div class="card h-100 bg-dark text-light shadow-lg border-0 hover-card">
                <div class="image-container">
                    <img src="{{ asset('images/fleet/kingair350i.jpg') }}" class="card-img-top object-fit-cover img-hover-zoom" style="height: 220px;" alt="Beechcraft King Air 350i">
                    <div class="image-caption">Image courtesy of Textron Aviation – media.txtav.com</div>
                </div>
                <div class="card-body">
                    <h5 class="card-title text-warning">Beechcraft King Air 350i</h5>
                    <ul class="list-unstyled">
                        <li><i class="fas fa-route text-warning me-2 icon-fix"></i> Max Range: 1,800 nm</li>
                        <li><i class="fas fa-tachometer-alt text-warning me-2 icon-fix"></i> Cruise Speed: 312 knots</li>
                        <li><i class="fas fa-arrow-up text-warning me-2 icon-fix"></i> Service Ceiling: 35,000 ft</li>
                        <li><i class="fas fa-user-friends text-warning me-2 icon-fix"></i> Capacity: 9 pax</li>
                        <li><i class="fas fa-plane text-warning me-2 icon-fix"></i> Tail: PH-NSB</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="text-center mt-5 px-3 px-md-5">
        <p class="lead text-light">
            <strong>North Sky VA</strong> operates a carefully selected fleet of light jets and turboprops designed for short- and medium-haul operations across Europe.  
            These aircraft are not just machines — they represent the premium world of executive charter aviation.
        </p>
        <p class="text-light small">
            Our fleet mirrors the real-world business aviation sector, where flexibility, privacy, and access to regional airports are essential. Whether you're flying a CJ4 into a corporate hub like London City, taking the King Air to a short runway in the Alps, or crossing half the continent in the Longitude — you're replicating the experience of real-world VIP charters.
        </p>
        <p class="text-light small">
            In this world, time is everything. That's why charter jets operate from private terminals, avoid queues, and deliver direct-to-destination convenience. This is not commercial aviation — this is flying on your terms.
        </p>
    </div>
</div>
@endsection
